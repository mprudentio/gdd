  ...
  return (
    <div className='w-full h-full bg-[#0a192f]'>
        <div className='max-w-[1000px] mx-auto px-8 py-8  h-full'>
            <div>
                <p className='text-[#E8710A] text-4xl font-bold'>A/B Testing</p>
                <img className='w-full h-[440px] rounded-md mt-4' src="./abtestinghero.jpg" alt="python icon" />
            </div>
            <div className='text-white mt-5'>
                <p className='text-xl  font-bold text-[#E8710A]'>Background</p>
            ...
            <div className='text-white mt-5'>
                <p className='text-xl  font-bold text-[#E8710A]'>Objectives</p>
            ...
            <div className='text-white mt-5'>
                <p className='text-xl  font-bold text-[#E8710A]'>Method & Results</p>
                <p>You can see the whole method & results by <a href='https://colab.research.google.com/drive/1Mwx0eRzxun2U370lpGZBal9vwja-WY7S?usp=sharing' rel="noreferrer" className='hover:text-[#E8710A]' target="_blank">clicking it</a></p>
            </div>
        </div>
    </div>
  )
